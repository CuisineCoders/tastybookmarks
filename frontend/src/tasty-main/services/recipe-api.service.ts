...
const MockRecipes = [
  ...
  },
  {
    ...
    imageUrl:
      'https://img.chefkoch-cdn.de/rezepte/1104411216466401/bilder/1318182/crop-642x428/lammkoteletts-im-tomaten-olivenoel-sud-mit-zweierlei-bohnen-und-kartoffelvierteln.jpg',
    ...
    instructions: [
      ['Grill chicken breasts and slice them.', 'Chop vegetables and mix with salad greens.'],
      ['Top with grilled chicken and dress with olive oil and lemon juice.', 'Season with salt and pepper.'],
    ],
    servingSize: 2,
  },
  {
  ...
  },
  {
    ...
    category: 'Breakfast',
    ingredient: ['1 cup Greek yogurt', '1/2 cup granola', '1/2 cup mixed berries', '1 tablespoon honey'],
    instructions: [
      ['Layer Greek yogurt, granola, and berries in a glass.', 'Drizzle with honey on top.', 'Serve immediately.'],
    ],
    servingSize: 1,
  },
  {
